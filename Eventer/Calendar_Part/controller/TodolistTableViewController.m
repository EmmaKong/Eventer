...
- (void)viewDidLoad {
    [super viewDidLoad];
    [[NSNotificationCenter defaultCenter]  addObserver:self selector:@selector(addSchedule:) name:@"addTodoScheduleNotification" object:nil];
...
{
    NSDictionary*condition=[NSDictionary dictionaryWithObjectsAndKeys:@"0",@"Status", nil];
