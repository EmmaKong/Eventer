...
- (float)calculateFavourHeightWithWidth:(float)sizeWidth{
    ...
    WFTextView *_wfcoreText = [[WFTextView alloc] initWithFrame:CGRectMake(commonOffset_X+28,10,  commonWidth-28, 0)];
...
- (float) calculateReplyHeightWithWidth:(float)sizeWidth{
    ...
    for (int i = 0; i < self.replyDataSource.count; i ++ ) {
        ...
        WFTextView *_ilcoreText = [[WFTextView alloc] initWithFrame:CGRectMake(commonOffset_X,10, commonWidth, 0)];
...
- (float) calculateShuoshuoHeightWithWidth:(float)sizeWidth withUnFoldState:(BOOL)isUnfold{
    ...
    WFTextView *_wfcoreText = [[WFTextView alloc] initWithFrame:CGRectMake(commonOffset_X,10, commonWidth, 0)];
